      ...
      <div className="relative max-w-7xl mx-auto px-4 py-8 sm:py-12">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
          ...
          <motion.h1
            ...
            className="text-3xl sm:text-4xl md:text-5xl font-bold bg-gradient-to-r from-gray-100 to-gray-300 text-transparent bg-clip-text mb-6"
          >
        ...
        <div className="relative max-w-5xl mx-auto mb-8 sm:mb-12 space-y-4 sm:space-y-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-4">
            ...
            <div className="flex items-center justify-between sm:ml-auto sm:gap-3">
